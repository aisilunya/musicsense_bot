...
class Musicsenseclient():
    ...
    def __init__(self, host,username, password):
        ...
        self.cookies = None
        self.context = {"time":"2016-11-01 14:10:45","ip":'8.8.8.8',"location":"disabled","locale":"en-US","device":"browser"}
    ...
    def musicfeed_suggest(self, q,tracksEnabled = True, limit = 20):
        ...
        response = requests.post(url, data = {'limit':limit,'tracksEnabled' : tracksEnabled, 'q':q}, cookies = self.cookies)
